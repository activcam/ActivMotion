...
const String txtpause = "Detection status pause";
const String txtstart = "Detection status activ";

// on/off
const int ONOFF_LED_PIN     = 16;     // pin D0 connected to the on/off led
boolean motionDetectionState = false; // motion detection on/off

// alert
int alertCounter            = 0;      // count motion detection 
int maxMotionAlert          = 1;      // set alert limit
const int MOTION_LED_PIN    = 5;      // pin D1 connected to the motion led 
const int ALERT_PIN_LOW     = 4;      // pin D2 connected to the alarm siren

// pir Sensor
const int MOTION_SENSOR_PIN = 14;     // pin D5 connected to the IN pin of motion sensor
int pirStateCurrent         = LOW;    

// motion state 
boolean motionStateCurrent   = false; // current  state of motion 
boolean motionStatePrevious  = false; // previous state of motion

// ultrasonic
const int ECHO_PIN          = 13;     // pin D7 connected to the echo pin
const int TRIG_PIN          = 15;     // pin D8 connected to the trigger pin
int duration_initial        = 0;
